...
func GetConfig() (*Config, error) {
	...
	flag.StringVar(&conf.RunAddress, "a", "localhost:8088", "Server address")
	flag.DurationVar(&conf.SyncInterval, "i", time.Second*3, "Accrual system data request interval")
	flag.StringVar(&conf.AccruralAddr, "r", "http://localhost:8080", "Accrual system address")
